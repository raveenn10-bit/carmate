  ...
  return (
    ...
    >
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-5 right-5 sm:bottom-6 sm:right-6 z-40 w-13 h-13 sm:w-14 sm:h-14 rounded-full bg-[#25D366] hover:bg-[#20bd5a] active:bg-[#1caa50] text-white shadow-[0_6px_28px_rgba(37,211,102,0.55)] hover:shadow-[0_8px_36px_rgba(37,211,102,0.7)] transition-all duration-300 hover:scale-110 active:scale-95 flex items-center justify-center group focus:outline-none focus:ring-2 focus:ring-white border border-white/20"
        aria-label="Chat with Carmate on WhatsApp"
      >
        {/* Subtle Ambient Pulse Ring */}
        <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#25D366] opacity-30 -z-10" />

        {/* Crisp Official WhatsApp Icon */}
        <svg
          viewBox="0 0 24 24"
          fill="currentColor"
          className="w-7 h-7 sm:w-8 sm:h-8 fill-white drop-shadow-sm transition-transform group-hover:scale-105"
          aria-hidden="true"
        >
        ...
        <span className="pointer-events-none absolute right-full mr-3 px-3 py-1.5 rounded-lg bg-black/90 text-white text-[11px] font-mono font-bold tracking-wider whitespace-nowrap opacity-0 translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-200 border border-white/15 shadow-xl hidden sm:block">
          WhatsApp ↗
        </span>
      </a>
    </footer>
