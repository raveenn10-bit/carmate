      ...
      >
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <button
            ...
            className="md:hidden min-w-[44px] min-h-[44px] p-2 flex items-center justify-center text-zinc-300 hover:text-white active:bg-white/10 rounded-lg focus:outline-none transition-colors"
              ...
              return (
                <Link
                  ...
                  className={`text-xs uppercase tracking-[0.14em] font-semibold py-2 transition-colors ${
                    isActive ? "text-[#ea1c24]" : "text-zinc-300 hover:text-white"
                  }`}
                >
                  {name}
                </Link>
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            style={{ backdropFilter: "blur(24px)", WebkitBackdropFilter: "blur(24px)", backgroundColor: "rgba(5,7,10,0.88)" }}
          >
            ...
            <div className="flex flex-col items-center pt-14 pb-4">
              <button
                ...
                className="min-w-[44px] min-h-[44px] flex items-center justify-center text-white/80 hover:text-white transition-colors"
              >
                ...
                return (
                  <motion.div key={name} variants={itemVariants} className="w-full flex justify-center">
                    <Link
                      href={href}
                      onClick={() => setMobileOpen(false)}
                      className={`flex items-center gap-4 px-8 py-4 min-h-[60px] text-2xl font-light tracking-wide transition-all select-none ${
                        isActive
                          ? "text-[#ea1c24]"
                    ...
                    >
                      <Icon
                        size={22}
                        strokeWidth={1.4}
                        className={isActive ? "text-[#ea1c24]" : "text-white/50"}
                      />
                      <span>{name}</span>
                    </Link>
                  </motion.div>
            ...
            <div className="flex justify-center pb-14 px-8">
              <motion.a
                ...
                exit={{ opacity: 0 }}
                className="w-full max-w-xs min-h-[52px] flex items-center justify-center gap-2 border border-white/30 hover:border-[#ea1c24] text-white hover:text-[#ea1c24] rounded-full text-sm font-medium tracking-widest uppercase transition-all active:scale-95"
              >
