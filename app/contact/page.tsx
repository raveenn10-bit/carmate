    ...
    <div className="py-24 bg-[#05070a] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-28">
          {/* Quote Builder Form */}
          <div className="lg:col-span-7 bg-[#090d14] border border-white/10 rounded-2xl p-8 sm:p-10 shadow-2xl">
            ...
            <form onSubmit={handleSendWhatsApp} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#121722] border border-white/10 rounded-xl px-4 py-3 text-sm text-white placeholder-zinc-500 focus:outline-none focus:border-[#ea1c24] focus:ring-1 focus:ring-[#ea1c24]"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-[#121722] border border-white/10 rounded-xl p-4 text-sm text-white placeholder-zinc-500 focus:outline-none focus:border-[#ea1c24] focus:ring-1 focus:ring-[#ea1c24]"
                />
              </div>

              <button
                type="submit"
                className="w-full bg-[#25d366] hover:bg-[#2ee672] text-[#05070a] font-bold text-xs uppercase tracking-wider py-4 rounded-xl flex items-center justify-center gap-2 shadow-[0_4px_20px_rgba(37,211,102,0.35)] transition-all transform hover:-translate-y-0.5"
              >
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="bg-[#090d14] border border-white/10 rounded-2xl p-8 shadow-xl">
              ...
              <div className="space-y-5 text-sm">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-xs text-[#ea1c24] font-semibold hover:underline mt-2 inline-block"
                    >
                      Open in Google Maps ↗
                    </a>
                  </div>
                ...
                <div className="flex items-center gap-3 pt-3 border-t border-white/5">
                  ...
                  <div>
                    ...
                    <a href="tel:+94777177452" className="text-zinc-400 text-xs hover:text-white">
                      +94 77 717 7452
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 pt-3 border-t border-white/5">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@carmate.lk" className="text-zinc-400 text-xs hover:text-white">
                      info@carmate.lk
                    </a>
                  </div>
                </div>
        ...
        <div className="max-w-3xl mx-auto">
          <h2 className="text-center text-3xl font-black uppercase text-white tracking-tight mb-8">
